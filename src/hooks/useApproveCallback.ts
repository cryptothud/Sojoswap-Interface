...
import { Trade, CurrencyAmount, Currency, NativeCurrency, TradeType } from '@uniswap/sdk'
...
export function useApproveCallback(
  ...
  const approvalState: ApprovalState = useMemo(() => {
    ...
    if (amountToApprove.currency instanceof NativeCurrency) return ApprovalState.APPROVED
